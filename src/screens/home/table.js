    ...
    return (
        <>
            <div style={{ backgroundColor: 'black', width: '100%', height: '100px', display: 'flex' }}>
                ...
                <Typography variant="body1" onClick={() => handleClick('/blogUpload')} style={{ marginRight: '20px', color: 'white', paddingTop: '50px', fontWeight: 'bold', paddingLeft: '20px' }}>
                    Blog
                </Typography>
                <Typography variant="body1" onClick={() => handleClick('/AdminReports')} style={{ marginRight: '20px', color: 'white', paddingTop: '50px', fontWeight: 'bold', paddingLeft: '20px' }}>
                    Report
                </Typography>
                <Typography variant="body1" onClick={() => handleClick('/AdminReports')} style={{ marginRight: '20px', color: 'white', paddingTop: '50px', fontWeight: 'bold', paddingLeft: '20px' }}>
                    Success Stories
            ...
            <div className='table-container'>
                <div style={{ display: 'flex', alignItems: 'left', marginBottom: '20px' }}>
                    <Button onClick={() => {handleClose();
                        handleOpenModal2();}} variant="contained" className="donationButton1">Add Blog</Button>
                </div>
                {uploadStatus && (
                ...
                >
                    <Box sx={style}>
                        ...
                        <NewBlogForm handleCloseModal={handleCloseModal}/>
                    </Box>
                </Modal>
            </div>
        </>
